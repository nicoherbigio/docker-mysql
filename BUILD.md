# Building instructions for the MySQL Docker image
...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/mysql:8.0-bookworm 8.0/debian/default/
```
...
docker push nicoherbigde/mysql:8.0-bookworm
```
